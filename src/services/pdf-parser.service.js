...
/**
 * Extrae texto de un PDF almacenado en Supabase Storage
...
/**
 * Valida que el texto extraído sea adecuado para TTS
...
export function validarTextoParaTTS(texto) {
  ...
  if (texto.length > 500000) {
    errores.push('El texto es demasiado largo (máximo 500,000 caracteres)');
  }
